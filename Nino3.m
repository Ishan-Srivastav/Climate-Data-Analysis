Data = [1948 -99.99 -99.99 -99.99 -99.99 -99.99 -99.99 -99.99 -99.99 -99.99 -99.99 -99.99 -99.99
 ...
 2022  -0.94  -0.89  -0.97  -1.11  -1.11  -0.75  -0.69  -0.98  -1.07  -0.98  -0.90  -0.85
 2023  -0.71  -0.56 -99.99 -99.99 -99.99 -99.99 -99.99 -99.99 -99.99 -99.99 -99.99 -99.99
];%Data 
dt = zeros(1,(2023-1948)*12);
for i = 1:900
    dt(i) = 1948+i/12;
end

t = Data(:,1); %time 
B = reshape(Data(:,2:13)',1,[]); %reshaping data in a leniar array
b = B(B > -90); % taking only the values that are recorder ie removing all NA values
y = detrend(b,1);% removing any trend if present
wt(y,dt) %perfoming wavelet transforn
% plot(y)
